...
public class NetUtil {
    ...
    /**
     * 清理连接
     * 如果是长连接，读取连接所有内容，再关闭，从而可以复用
     * <p>
     * according to https://docs.oracle.com/javase/7/docs/technotes/guides/net/http-keepalive.html, we should clean
     * up the connection by reading the response body so that the connection could be reused.
     */
